...
import { CustomerListTable } from '../../../components/dashboard/debtor/debtor-list-table';
...
import { debtorApi } from '../../../__fake-api__/debtor-api';
...
const CustomerList = () => {
    ...
    const getCustomers = useCallback(async () => {
        try {
            const data = await debtorApi.getDebtors();
