...
import { CustomerListTable } from '../../../components/dashboard/collector/collector-list-table';
...
import { collectorApi } from '../../../__fake-api__/collectors-api';
...
const CustomerList = () => {
    ...
    const getCustomers = useCallback(async () => {
        try {
            const data = await collectorApi.getCollectors();
