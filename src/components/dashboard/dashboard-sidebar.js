    ...
    items: [
      {
        ...
        children: [
          ...
          // {
          //   title: t('Details'),
          //   path: '/dashboard/portfolios/1'
          // },
          // {
          //   title: t('Edit'),
          //   path: '/dashboard/portfolios/1/edit'
          // }
        ]
      },
      {
      ...
      },
      {
        ...
        children: [
          ...
          {
            title: t('Details'),
            path: '/dashboard/debtors/1'
          },
          {
            title: t('Edit'),
            path: '/dashboard/debtors/1/edit'
          }
        ]
      },
      {
        ...
        children: [
          ...
          {
            title: t('Details'),
            path: '/dashboard/collectors/1'
          },
          {
            title: t('Edit'),
            path: '/dashboard/collectors/1/edit'
          }
        ]
      },
      {
